...
from lib.dataset.PIFuMRDataModule import PIFuMRDataModule
from lib.common.config import get_cfg_defaults
from lib.common.train_util import SubTrainer, load_networksMR,load_networks
import os
...
if __name__ == "__main__":
    ...
    datamodule = PIFuMRDataModule(cfg)
