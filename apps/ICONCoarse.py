...
from lib.net import HGPIFuCoarseNet
...
class ICONCoarse(pl.LightningModule):

    def __init__(self, cfg):
        super(ICONCoarse, self).__init__()
    ...
    def test_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            #     img1, img2 = self.reconEngine.get_FB_normal(sdf)
        ...
        #         plt.imsave(batch['save_path_F'][0], img1)
        #         plt.imsave(batch['save_path_B'][0], img2)
        # return
