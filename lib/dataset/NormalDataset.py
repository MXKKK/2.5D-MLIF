...
class NormalDataset():
    ...
    def __getitem__(self, index):
        ...
        data_dict = {
            ...
            'save_path_F':
            osp.join(self.root, render_folder, 'F_normal_F', f'{rotation:03d}.png'),
            'save_path_B':
            osp.join(self.root, render_folder, 'F_normal_B', f'{rotation:03d}.png'),
            'folder_B':
            osp.join(self.root, render_folder, 'F_normal_B'),
            'folder_F':
            osp.join(self.root, render_folder, 'F_normal_F'),
        }
