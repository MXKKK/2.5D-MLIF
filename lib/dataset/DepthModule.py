...
class DepthModule(pl.LightningDataModule):
    ...
    def setup(self, stage):
        ...
        if stage == 'fit' or stage is None:
            self.train_dataset = DepthDataset(cfg=self.cfg, split="train")
            self.val_dataset = DepthDataset(cfg=self.cfg, split="val")
            self.data_size = {
        ...
        if stage == 'test' or stage is None:
            self.test_dataset = DepthDataset(cfg=self.cfg, split="test")
