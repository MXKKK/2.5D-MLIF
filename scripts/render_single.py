...
smplx_file = f'./data/{dataset}/Paras/{subject}mesh_smplx.obj'
tex_file = f'./data/{dataset}/Textures/{subject}-D.jpg'
fit_file = f'./data/{dataset}/Paras/{subject}/smplx_param.pkl'
...
if pcd:
    ...
    rndr = PRTRender(width=size, height=size, ms_rate=1, egl=egl)
